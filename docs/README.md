...
| [Fuzzy Search](./features/FUZZY_SEARCH.md) | Search implementation guide |
...
| Document | Description |
|----------|-------------|
| [Convex Components](./CONVEX_COMPONENTS.md) | Rate limiter, cache, aggregates |
...
- **Backend Testing:** [convex/README.md](../convex/README.md)
