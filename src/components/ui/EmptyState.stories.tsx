...
const meta: Meta<typeof EmptyState> = {
	...
	argTypes: {
		...
		action: {
			description:
				"Optional action - can be a ReactNode or an object with label and onClick",
		},
		className: {
			control: "text",
...
export const ErrorLoadFailed: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Empty state for when data fails to load.",
			},
		},
	},
};
...
export const ErrorOffline: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Empty state for when the user is offline.",
			},
		},
	},
};
...
export const ErrorPermission: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Empty state for when the user lacks permission.",
			},
		},
	},
};
...
export const ErrorNotFound: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Empty state for 404 not found errors.",
			},
		},
	},
};
...
export const CompleteWithAllProps: Story = {
	args: {
		...
		description: "Get started by creating your first project. You can invite team members, track issues, and collaborate on documents all in one place.",
		action: {
			label: "Get Started",
