...
export const SuccessIndicator: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Progress bar with success (green) indicator color.",
			},
		},
	},
};
...
export const WarningIndicator: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Progress bar with warning (yellow/orange) indicator color.",
			},
		},
	},
};

export const ErrorIndicator: Story = {
	args: {
		value: 30,
	...
	parameters: {
		docs: {
			description: {
				story: "Progress bar with error (red) indicator color.",
			},
		},
	},
};
	...
	render: () => (
		<div className="flex flex-col gap-4 w-80">
			<div className="flex flex-col gap-1">
				<span className="text-sm text-ui-text-secondary">Brand (default)</span>
				<Progress value={70} />
			</div>
			<div className="flex flex-col gap-1">
				<span className="text-sm text-ui-text-secondary">Success</span>
				<Progress value={70} indicatorClassName="bg-status-success" />
			</div>
			<div className="flex flex-col gap-1">
				<span className="text-sm text-ui-text-secondary">Warning</span>
				<Progress value={70} indicatorClassName="bg-status-warning" />
			</div>
			<div className="flex flex-col gap-1">
				<span className="text-sm text-ui-text-secondary">Error</span>
				<Progress value={70} indicatorClassName="bg-status-error" />
			</div>
		</div>
	),
	parameters: {
		docs: {
			description: {
				story: "Progress bars with different semantic color indicators.",
			},
		},
	},
};
...
export const Animated: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Animated progress bar that continuously fills and resets. Demonstrates the smooth transition animation.",
			},
		},
	},
};
...
function AnimatedLoadingProgress() {
	...
	return (
		<div className="flex flex-col gap-2 w-80">
			<Progress value={value} />
			<span className="text-sm text-ui-text-secondary text-center">
				Loading... {value}%
			</span>
		</div>
	);
...
export const AnimatedLoading: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Simulated loading progress that slows down as it approaches completion. Common UX pattern for indeterminate loading.",
			},
		},
	},
};
		...
		<div className="flex flex-col gap-3 w-80 p-4 border border-ui-border rounded-lg">
			<div className="flex items-center gap-3">
				...
				<div className="flex-1 min-w-0">
					<div className="text-sm font-medium text-ui-text truncate">
						project-assets.zip
					</div>
	...
	render: () => (
		<div className="flex flex-col gap-4 w-80">
			...
			<div className="flex flex-col gap-1">
				...
				<Progress value={87} indicatorClassName="bg-status-warning" />
			</div>
			<div className="flex flex-col gap-1">
				<div className="flex justify-between text-sm">
				...
				<Progress value={95} indicatorClassName="bg-status-error" />
			</div>
		</div>
	),
	parameters: {
		docs: {
			description: {
				story: "Multiple progress bars showing different usage metrics with semantic colors indicating severity.",
			},
		},
	},
};
