...
export const Basic: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"A basic popover with a trigger button and content containing form fields.",
			},
		},
	},
};
		...
		<Popover>
			...
			<PopoverContent className="w-80">
				<p className="text-sm text-ui-text">
					This is a simple popover with text content. Popovers can contain any
					content and are great for showing additional information on demand.
				</p>
			</PopoverContent>
		</Popover>
	),
...
export const SettingsPanel: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"A settings panel popover with toggle options, commonly used in app headers.",
			},
		},
	},
};
...
export const DatePickerTrigger: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"A date picker trigger pattern showing how to use a popover for date selection.",
			},
		},
	},
};
...
export const ColorPicker: Story = {
						...
						<div className="grid gap-2">
							...
							<div className="flex gap-2">
								<Input
									...
									onChange={(e) =>
										setSelectedColor({ name: "Custom", value: e.target.value })
									}
									className="flex-1"
								/>
								<input
	...
	parameters: {
		docs: {
			description: {
				story:
					"A color picker popover with preset colors and custom color input.",
			},
		},
	},
};
			...
			<div className="flex gap-2">
				...
				<Popover open={open} onOpenChange={setOpen}>
					...
					<PopoverContent>
						<div className="grid gap-4">
							<p className="text-sm">
								This is a controlled popover. Its state is managed by React
								state.
							</p>
...
export const CustomWidths: Story = {
	render: () => (
		<div className="flex gap-4">
			...
			<Popover>
				...
				<PopoverContent>
					<p className="text-sm">
						This is the default popover width at 288px (w-72).
					</p>
				</PopoverContent>
			</Popover>
			...
			<Popover>
				...
				<PopoverContent className="w-96">
					<p className="text-sm">
						This is a wider popover at 400px. Useful for forms or complex
	...
	parameters: {
		docs: {
			description: {
				story:
					"Popovers with different widths to accommodate various content sizes.",
			},
		},
	},
};
...
export const RichContent: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"A popover with rich content including an avatar, user details, and action buttons.",
			},
		},
	},
};
...
export const MultiplePopovers: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Multiple independent popovers on the same page. Opening one closes the others.",
			},
		},
	},
};
