	...
	render: () => (
		<Accordion type="single" collapsible className="w-96">
			<AccordionItem value="item-1">
				...
				<AccordionContent>
					Nixelo is a collaborative project management platform that combines document
					management with issue tracking, featuring real-time collaboration and
					presence indicators.
				</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-2">
				...
				<AccordionContent>
					Sign up for an account, create your first workspace, and invite your team
					members. You can then create projects, documents, and start tracking issues.
				</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-3">
				<AccordionTrigger>Is there a free plan?</AccordionTrigger>
				<AccordionContent>
					Yes! We offer a generous free tier that includes unlimited projects, up to 5
					team members, and all core features. Upgrade anytime for advanced features.
				</AccordionContent>
			</AccordionItem>
		</Accordion>
	),
...
export const MultipleExpand: Story = {
	render: () => (
		<Accordion type="multiple" className="w-96">
			<AccordionItem value="item-1">
				...
				<AccordionContent>
					This is the content for the first section. Multiple items can be expanded
			...
			<AccordionItem value="item-2">
				...
				<AccordionContent>
					This is the content for the second section. Try opening this while keeping
			...
			<AccordionItem value="item-3">
				...
				<AccordionContent>
					This is the content for the third section. All three sections can be open
					at the same time.
				</AccordionContent>
			</AccordionItem>
		</Accordion>
	...
	parameters: {
		docs: {
			description: {
				story:
					"Multiple expand accordion where any number of items can be open simultaneously.",
			},
		},
	},
};
...
export const FAQ: Story = {
		...
		<div className="w-full max-w-2xl">
			...
			<Accordion type="single" collapsible>
				<AccordionItem value="faq-1">
					...
					<AccordionContent>
						Nixelo uniquely combines document management (similar to Confluence) with
						issue tracking (similar to Jira) in a single, seamlessly integrated
						platform. Our real-time collaboration features let you see who's working
						on what, with live presence indicators and instant updates.
					</AccordionContent>
				</AccordionItem>
				<AccordionItem value="faq-2">
					...
					<AccordionContent>
						The free plan includes up to 5 team members. Our Pro plan supports up to
						50 members, and our Enterprise plan offers unlimited team members with
				...
				<AccordionItem value="faq-3">
					...
					<AccordionContent>
						Absolutely. We use industry-standard encryption for all data in transit
						and at rest. Our infrastructure is hosted on secure cloud providers with
						SOC 2 Type II compliance. We also offer role-based access control (RBAC)
						to ensure only authorized team members can access sensitive information.
					</AccordionContent>
				</AccordionItem>
				<AccordionItem value="faq-4">
					...
					<AccordionContent>
						Yes, you can cancel your subscription at any time. Your account will
						remain active until the end of your current billing period. We also offer
				...
				<AccordionItem value="faq-5">
					...
					<AccordionContent>
						You can reach our support team via email at support@nixelo.com, through
						the in-app chat widget, or by opening a support ticket in your dashboard.
						Pro and Enterprise customers have access to priority support with faster
						response times.
					</AccordionContent>
				</AccordionItem>
			</Accordion>
	...
	parameters: {
		docs: {
			description: {
				story:
					"A complete FAQ section with icons and detailed answers, using single expand mode.",
			},
		},
	},
};
	...
	render: () => (
		<div className="w-full max-w-lg">
			...
			<Accordion type="multiple" defaultValue={["profile"]} className="space-y-2">
				...
				<AccordionItem
					value="notifications"
					className="rounded-lg border border-ui-border px-4"
				>
					<AccordionTrigger>
						<span className="flex items-center gap-3">
...
export const NonCollapsibleSingle: Story = {
	render: () => (
		<Accordion type="single" defaultValue="item-1" className="w-96">
			<AccordionItem value="item-1">
				...
				<AccordionContent>
					In non-collapsible mode, at least one item must always be expanded. Try
					clicking other items - the current one will close as the new one opens.
				</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-2">
				<AccordionTrigger>Second Option</AccordionTrigger>
				<AccordionContent>
					Clicking on an already-open item won't close it in this mode. You must click
					on a different item to change the selection.
				</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-3">
				<AccordionTrigger>Third Option</AccordionTrigger>
				<AccordionContent>
					This pattern is useful when you always want to show some content, like in a
					step-by-step wizard or required information display.
				</AccordionContent>
			</AccordionItem>
		</Accordion>
	),
	parameters: {
		docs: {
			description: {
				story:
					"Single accordion without `collapsible` prop - one item must always remain open.",
			},
		},
	},
};
...
export const RichContent: Story = {
				...
				<AccordionContent>
					<div className="space-y-4">
						<p className="text-ui-text">
							Our platform offers a comprehensive set of features designed to boost
						...
						<div className="rounded-md bg-ui-bg-hover p-3">
							<p className="text-sm text-ui-text-secondary">
								<strong className="text-ui-text">Pro tip:</strong> You can customize
								your workflow states to match your team's existing processes.
							</p>
						</div>
					</div>
				</AccordionContent>
	...
	parameters: {
		docs: {
			description: {
				story:
					"Accordion with rich content including lists, styled boxes, and complex layouts.",
			},
		},
	},
};
