...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-10 items-center space-x-1 rounded-lg border border-ui-border bg-ui-bg-elevated p-1 shadow-soft",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-md px-3 py-1.5 text-sm font-medium text-ui-text outline-none transition-default focus:bg-ui-bg-hover data-[state=open]:bg-ui-bg-hover",
      className,
    )}
    {...props}
  />
...
>(({ className, align = "start", alignOffset = -4, sideOffset = 8, ...props }, ref) => (
  <MenubarPrimitive.Portal>
    <MenubarPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-48 overflow-hidden rounded-lg border border-ui-border bg-ui-bg-elevated p-1 text-ui-text shadow-elevated",
        "data-[state=open]:animate-scale-in data-[state=closed]:animate-scale-out",
        className,
      )}
      {...props}
