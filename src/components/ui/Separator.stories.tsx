...
export const Horizontal: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Horizontal separator (default). Creates a visual divider spanning the full width.",
      },
    },
  },
};
  ...
  render: () => (
    <div className="flex w-80 flex-col gap-4">
      ...
      <div>
        ...
        <p className="text-sm text-ui-text-secondary">
          This is the second section of content separated by a horizontal divider.
        </p>
      </div>
    </div>
  ),
  ...
  render: () => (
    <div className="w-72 rounded-lg border border-ui-border bg-ui-bg-secondary p-4">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-ui-text-secondary">Card description goes here.</p>
      </div>
...
export const InToolbar: Story = {
  render: () => (
    <div className="flex items-center gap-2 rounded-lg border border-ui-border bg-ui-bg-secondary p-2">
      <button type="button" className="rounded p-2 hover:bg-ui-bg-tertiary">
  ...
  parameters: {
    docs: {
      description: {
        story: "Vertical separators used in a toolbar to group related actions.",
      },
    },
  },
};
...
export const InDropdownMenu: Story = {
  render: () => (
    <div className="w-48 rounded-lg border border-ui-border bg-ui-bg-secondary py-1 shadow-lg">
      <button type="button" className="w-full px-3 py-2 text-left text-sm hover:bg-ui-bg-tertiary">
        Profile
      </button>
      <button type="button" className="w-full px-3 py-2 text-left text-sm hover:bg-ui-bg-tertiary">
        Settings
