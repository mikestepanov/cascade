...
export const Lead: Story = {
	args: {
		variant: "lead",
		children:
			"This is lead text, typically used for introductory paragraphs or emphasis.",
	},
};
	...
	render: () => (
		<div className="flex max-w-2xl flex-col gap-6">
			...
			<Typography variant="p">
				Paragraph - Regular body text with comfortable line height for extended
				reading. This is the default variant and works well for most content.
			</Typography>
			<Typography variant="large">
				Large text - Emphasized text that stands out.
			</Typography>
			<Typography variant="small">
				Small text - Reduced size for captions and metadata.
			</Typography>
			...
			<Typography variant="p">
				Inline code example: <Typography variant="inlineCode">npm install</Typography> runs package installation.
			</Typography>
		</div>
	),
	parameters: {
		...
		docs: {
			description: {
				story:
					"Complete typography scale showing all text variants from h1 to muted.",
			},
		},
	},
};
...
export const ArticleExample: Story = {
	render: () => (
		<article className="flex max-w-2xl flex-col gap-4">
			...
			<Typography variant="lead">
				A comprehensive guide to setting up your first project and understanding
				the core concepts.
			</Typography>
			...
			<Typography variant="p">
				...
				This file will contain all the settings needed to connect to your
				workspace.
			</Typography>
			<Typography variant="blockquote">
				Pro tip: Keep your API keys secure by using environment variables
				instead of hardcoding them in your configuration.
			</Typography>
	...
	parameters: {
		...
		docs: {
			description: {
				story:
					"Example of typography variants used together in an article layout.",
			},
		},
	},
};
