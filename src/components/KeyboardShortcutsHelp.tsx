      ...
      <div className="p-6 space-y-6">
        {shortcuts.map((section) => (
          <div key={section.category}>
            <h3 className="text-lg font-semibold text-ui-text-primary dark:text-ui-text-primary-dark mb-3">{section.category}</h3>
            <div className="space-y-2">
              {section.items.map((shortcut) => (
                <div key={shortcut.description} className="flex items-center justify-between py-2">
                  <span className="text-sm text-ui-text-primary dark:text-ui-text-primary-dark">{shortcut.description}</span>
        ...
        <div className="pt-4 border-t border-ui-border-primary dark:border-ui-border-primary-dark">
          <p className="text-sm text-ui-text-secondary dark:text-ui-text-secondary-dark">
            ...
            <kbd className="px-2 py-1 text-xs bg-ui-bg-tertiary dark:bg-ui-bg-tertiary-dark border border-ui-border-primary dark:border-ui-border-primary-dark rounded">⌘ K</kbd>{" "}
