  ...
  return (
    <div className="relative">
      <textarea
        ...
        className={`w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:bg-gray-800 dark:text-gray-100 resize-none overflow-hidden ${className}`}
        rows={3}
      />
