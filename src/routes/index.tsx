    ...
    <div className="min-h-screen w-full bg-ui-bg-hero text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{ backgroundColor: "var(--brand-500)", opacity: 0.1 }}
        />
        <div
          className="absolute top-1/2 right-1/4 w-96 h-96 rounded-full blur-[120px]"
          style={{ backgroundColor: "var(--status-info-text)", opacity: 0.1 }}
        />
        <div
          className="absolute bottom-20 left-1/3 w-64 h-64 rounded-full blur-[120px]"
          style={{ backgroundColor: "var(--status-success-text)", opacity: 0.1 }}
        />
      </div>
