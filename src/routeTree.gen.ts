...
const AuthAppCompanySlugTimeTrackingRoute = AuthAppCompanySlugTimeTrackingRouteImport.update({
  id: "/time-tracking",
  path: "/time-tracking",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
const AuthAppCompanySlugDashboardRoute = AuthAppCompanySlugDashboardRouteImport.update({
  id: "/dashboard",
  path: "/dashboard",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
const AuthAppCompanySlugWorkspacesIndexRoute = AuthAppCompanySlugWorkspacesIndexRouteImport.update({
  id: "/workspaces/",
  path: "/workspaces/",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
const AuthAppCompanySlugSettingsIndexRoute = AuthAppCompanySlugSettingsIndexRouteImport.update({
  id: "/settings/",
  path: "/settings/",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
const AuthAppCompanySlugProjectsIndexRoute = AuthAppCompanySlugProjectsIndexRouteImport.update({
  id: "/projects/",
  path: "/projects/",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
const AuthAppCompanySlugDocumentsIndexRoute = AuthAppCompanySlugDocumentsIndexRouteImport.update({
  id: "/documents/",
  path: "/documents/",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
const AuthAppCompanySlugSettingsProfileRoute = AuthAppCompanySlugSettingsProfileRouteImport.update({
  id: "/settings/profile",
  path: "/settings/profile",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
const AuthAppCompanySlugIssuesKeyRoute = AuthAppCompanySlugIssuesKeyRouteImport.update({
  id: "/issues/$key",
  path: "/issues/$key",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
...
const AuthAppCompanySlugDocumentsIdRoute = AuthAppCompanySlugDocumentsIdRouteImport.update({
  id: "/documents/$id",
  path: "/documents/$id",
  getParentRoute: () => AuthAppCompanySlugRouteRoute,
} as any);
...
const AuthAppCompanySlugWorkspacesWorkspaceSlugTeamsTeamSlugIndexRoute =
  AuthAppCompanySlugWorkspacesWorkspaceSlugTeamsTeamSlugIndexRouteImport.update({
    id: "/",
    path: "/",
    getParentRoute: () => AuthAppCompanySlugWorkspacesWorkspaceSlugTeamsTeamSlugRouteRoute,
  } as any);
...
const AuthAppCompanySlugProjectsKeyRouteRouteChildren: AuthAppCompanySlugProjectsKeyRouteRouteChildren =
  {
    AuthAppCompanySlugProjectsKeyBoardRoute: AuthAppCompanySlugProjectsKeyBoardRoute,
    AuthAppCompanySlugProjectsKeyCalendarRoute: AuthAppCompanySlugProjectsKeyCalendarRoute,
    AuthAppCompanySlugProjectsKeySettingsRoute: AuthAppCompanySlugProjectsKeySettingsRoute,
    AuthAppCompanySlugProjectsKeyTimesheetRoute: AuthAppCompanySlugProjectsKeyTimesheetRoute,
    AuthAppCompanySlugProjectsKeyIndexRoute: AuthAppCompanySlugProjectsKeyIndexRoute,
  };
...
const AuthAppCompanySlugRouteRouteChildren: AuthAppCompanySlugRouteRouteChildren = {
  ...
  AuthAppCompanySlugProjectsKeyRouteRoute: AuthAppCompanySlugProjectsKeyRouteRouteWithChildren,
  ...
  AuthAppCompanySlugDocumentsTemplatesRoute: AuthAppCompanySlugDocumentsTemplatesRoute,
  AuthAppCompanySlugIssuesKeyRoute: AuthAppCompanySlugIssuesKeyRoute,
  AuthAppCompanySlugSettingsProfileRoute: AuthAppCompanySlugSettingsProfileRoute,
  AuthAppCompanySlugDocumentsIndexRoute: AuthAppCompanySlugDocumentsIndexRoute,
  ...
  AuthAppCompanySlugWorkspacesIndexRoute: AuthAppCompanySlugWorkspacesIndexRoute,
};

const AuthAppCompanySlugRouteRouteWithChildren = AuthAppCompanySlugRouteRoute._addFileChildren(
